...
typedef struct DNS_question {
    char* q_name;              // 域名或IP地址，如www.bupt.edu.cn
    uint16_t q_type;           // 资源类型，如A记录(1)、MX记录(15)等
    uint16_t q_class;          // 地址类型，如IN(1)
